...
export default function Header() {
  ...
  return (
    <header className="bg-black text-white font-inter h-20 w-full">
      <div className="container mx-auto">
        <div className="flex justify-between items-center h-20">
          {/* Desktop Navigation */}
          <nav className="hidden md:flex gap-6 pl-10">
            <button
          ...
          {/* Logo */}
          <div className="">
            <Link href="/" className="flex items-center pl-4 mr-14 md:pl-0">
              <img
                src="/assets/images/saharilogo8.png"
                alt="Logo"
        ...
        {isOpen && (
          <div className="md:hidden bg-black">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <button
                onClick={() => scrollToSection("products")}
                className="block text-white hover:bg-gray-700 rounded-md px-3 py-2 text-base font-medium w-full text-left"
              >
                Our Products
              </button>
              <button
